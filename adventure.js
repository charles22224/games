...
health = 150
small_demon_health = 50
meduim_demon_health = 50
Large_demon_health = 50
let playerName = "Sung Jin Woo";
let inventory = [Dagger];
let location = "house"; // Starting location
let gameOver = false;
let dagger = 10 dammage
function startGame() {
playerName = prompt("Welcome to the dungeons);
let dammage + -10 demon_health
